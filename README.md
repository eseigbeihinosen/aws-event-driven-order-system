...
- [Screenshots](#screenshots)
  ...
  - [2. Amazon RDS Database](#2-amazon-rds-database)
  - [3. AWS Secrets Manager](#3-aws-secrets-manager)
  - [4. Lambda Function](#4-lambda-function)
  - [5. Lambda Environment Variables](#5-lambda-environment-variables)
  - [6. Lambda Layer](#6-lambda-layer)
  - [7. Amazon API Gateway](#7-amazon-api-gateway)
  - [8. Amazon SNS Topic](#8-amazon-sns-topic)
  - [9. Amazon SQS Queues](#9-amazon-sqs-queues)
  - [10. SNS Subscriptions](#10-sns-subscriptions)
  - [11. Successful Lambda Test](#11-successful-lambda-test)
  - [12. API Test from PowerShell](#12-api-test-from-powershell)
  - [13. Database Verification](#13-database-verification)
  - [14. SQS Message](#14-sqs-message)
